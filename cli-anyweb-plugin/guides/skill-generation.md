...
### 1. YAML Frontmatter 鈥?Triggering metadata for skill discovery:
...
### 2. Markdown Body 鈥?Usage instructions including:
...
# Default output: cli_anyweb/<software>/skills/SKILL.md
```
...
from cli_anyweb.<software>.utils.repl_skin import ReplSkin

skin = ReplSkin("<software>", version="1.0.0")
skin.print_banner()  # Auto-detects and displays: 鈼?Skill: /path/to/cli_anyweb/<software>/skills/SKILL.md
```
