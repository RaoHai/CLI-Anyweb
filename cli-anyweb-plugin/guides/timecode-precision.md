...
- `int(9000 * 29.97)` 鈥?**wrong**, truncates and loses frames
- `round(9000 * 29.97)` 鈥?**correct**, gets the right answer

## Use Integer Arithmetic for Timecode Display

Convert frames 鈫?total milliseconds via:
```python
...
## Accept 卤1 Frame Tolerance

In roundtrip tests at non-integer FPS, exact equality is mathematically impossible. Accept 卤1 frame tolerance.
