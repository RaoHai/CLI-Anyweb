...
class TestDirectCommands:
    ...
    def setup_method(self):
        from cli_anyweb import cli_anyweb_cli as cli_mod
    ...
    def test_open_command_uses_page_module(self):
        runner = CliRunner()
        with patch("cli_anyweb.cli_anyweb_cli.page_mod.open_page") as mock_open:
    ...
    def test_snapshot_command_prints_snapshot_text(self):
        runner = CliRunner()
        with patch("cli_anyweb.cli_anyweb_cli.backend.snapshot") as mock_snapshot:
    ...
    def test_get_command_json_output(self):
        runner = CliRunner()
        with patch("cli_anyweb.cli_anyweb_cli.backend.get_value") as mock_get:
    ...
    def test_find_command_prints_matches(self):
        runner = CliRunner()
        with patch("cli_anyweb.cli_anyweb_cli.backend.find") as mock_find:
    ...
    def test_click_command_uses_backend(self):
        runner = CliRunner()
        with patch("cli_anyweb.cli_anyweb_cli.backend.click") as mock_click:
    ...
    def test_type_command_uses_backend(self):
        runner = CliRunner()
        with patch("cli_anyweb.cli_anyweb_cli.backend.type_text") as mock_type:
